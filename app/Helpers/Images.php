...
function LoadImage($imgname)
{
    ...
    try {
        ...
        $im = imagecreatefromjpeg(public_path() . DIRECTORY_SEPARATOR . 'image_generator' . DIRECTORY_SEPARATOR . 'default.jpg');
        return $im;
    }
}
...
{
    $path = public_path() . DIRECTORY_SEPARATOR . 'image_generator' . DIRECTORY_SEPARATOR;
    ...
    do {
        $fileName = $path . 'results' . DIRECTORY_SEPARATOR . 'img_' . rand(11111, 99999) . '.jpg';
